    ...
    <section id="kukuys" class="container mx-auto px-6 pb-30 pt-5">
        ...
        <div class="text-center mt-12">
            <button 
                ...
                class="bg-gradient-to-r from-green-600 to-emerald-500 text-white px-8 py-4 rounded-lg font-bold text-lg hover:from-green-700 hover:to-emerald-600 transition-all transform hover:scale-105 shadow-lg shadow-green-500/25 flex items-center gap-3 mx-auto"
            >
                {{ showMore ? 'Show Less' : 'See More Streamers' }}
            ...
            streamers: [
                {
                    ...
                    name: 'Gabbi',
                    nameIcon: '',
                    tags: ['Professional Dota 2 Player', 'Position 1 | Carry', 'Major Champion', 'WESG Champion'],
                    ...
                    name: 'Kuku',
                    nameIcon: '',
                    tags: ['GodFather of PH Dota 2','Professional Dota 2 Player', 'Position 5 | Hard Support', 'WESG Champion'],
                    ...
                    name: 'Armel',
                    nameIcon: '',
                    tags: ['Professional Dota 2 Player', 'Position 2 | Midlaner', 'Major Champion', 'WESG Champion'],
                    ...
                    isLive: false,
                    icon: 'fab fa-kickstarter',
                    image: 'images/kukuys_streamer/armel.jpg'
                },{
                    id: 4,
                    name: 'DJ',
                    nameIcon: '',
                    ...
                    name: 'Karl',
                    nameIcon: '',
                    tags: ['Professional Dota 2 Player', 'Position 2 | Midlaner', 'ESL One Champion'],
